...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "darkbutterfly")
OWNER_ID = list(map(int, getenv("OWNER_ID", "5483829443").split()))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/RedeyeServiceGroup")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/RedeyeServiceGroup")
...
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/4323f20459fecd372d409.jpg")
...
if PING_IMG_URL:
    if PING_IMG_URL != "SankiMuic/resource/Ping.jpeg":
...
if START_IMG_URL:
    if START_IMG_URL != "SankiMusic/resource/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://telegra.ph/file/4323f20459fecd372d409.jpg"
